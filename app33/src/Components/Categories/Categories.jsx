...
const options = {
  method: 'GET',
  url: `https://free-to-play-games-database.p.rapidapi.com/api/games?category=${genre}`,
  headers: {
...
<Helmet>
        <meta charSet="utf-8" />
        <title className='text-capitalize'> {genre} games</title>
  </Helmet>
...
<section>
  <div className="container py-5">
    ...
    {genreItem.slice(0,more).map((item,index)=><>
